...
class addstudents(models.Model):
    STUDENT_ID=models.ForeignKey(LoginTable, on_delete=models.CASCADE,null=True,blank=True,related_name='studentid')
    name=models.CharField(max_length=60,null=True,blank=True)
    course=models.CharField(max_length=60,null=True,blank=True)
    semester=models.CharField(max_length=60,null=True,blank=True)
    phoneno=models.IntegerField(null=True,blank=True)
    email=models.CharField(max_length=30,null=True,blank=True)
    CLUB_ID=models.ForeignKey(LoginTable, on_delete=models.CASCADE,null=True,blank=True,related_name='clubid')
