...
urlpatterns = [
    ...
    path('clubnotification/',clubnotification.as_view(),name='clubnotification'),
...
#//////////////CLUB///////////////
   ...
   path('viewinstructions/',viewinstructions.as_view(),name='viewinstructions'),
   path('addstudents/',addstudent.as_view(),name='addstudents'),
   path('remove_student/<int:id>',remove_student.as_view(),name='remove_student'),
